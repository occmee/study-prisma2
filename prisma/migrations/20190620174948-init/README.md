# Migration `20190620174948-init`

This migration has been generated by occmee at 6/20/2019, 5:49:48 PM.
...
You can use a specific Photon built for this migration (20190620174948-init)
in your `before` or `after` migration script like this:

```ts
import Photon from '@generated/photon/20190620174948-init'
